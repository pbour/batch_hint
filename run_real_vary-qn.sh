...
for qn in 1 5 50 100
do
        qfile="queries/real/$1_qe0.1%_qn${qn}K.qry"
        if [ "$#" -eq 4 ]; then
                ofile="outputs/real/$1_qe0.1%_qn${qn}K_oSUBS+SORT+SS+CM_m$2_qGOVERLAPS_b${b}.out"
...
#        elif [ "$#" -eq 5 ] && ([ $5 = "SORTED" ] || [ $5 = "sorted" ]); then
                ...
                ofile="outputs/real/$1_qe0.1%_qn${qn}K_oSUBS+SORT+SS+CM_m$2_qGOVERLAPS_b${b}_withSORT.out"
